...
export const midnightDossier: Theme = {
  ...
  lexicon: {
    ...
    menu: {
      passPlay: {
        title: 'Pass & Play',
        body: 'One phone around the table. Handoffs keep every role secret.',
      },
      party: {
        title: 'Party Mode',
        body: 'A big screen runs the op. Every agent plays from their own phone.',
      },
      hostJoin: {
        title: 'Host & Join',
        body: 'No big screen. Every agent runs the whole op from their phone.',
      },
      back: 'Menu',
    },
    party: {
      chooser: {
        title: 'Party Mode',
        subtitle: 'One shared screen. Every agent on their own phone.',
        hostCta: 'Host on this screen',
        hostBody: 'Use this device as the shared big screen — a laptop or TV works best.',
        joinCta: 'Join with a code',
        joinBody: 'Play from this phone using the room code on the big screen.',
        notConfigured:
          'Party Mode needs its network backend. Set the Supabase keys (see .env.example) to bring it online.',
      },
      host: {
        roomCode: 'Room code',
        joinHint: 'On your phone: open {url}, pick Party Mode → Join, and enter the code.',
        players: '{count} joined',
        needPlayers: 'Waiting for at least {min} agents…',
        start: 'Assign roles',
        roleTitle: 'Check your phones',
        roleBody: 'Your role just landed on your phone. Read it in private, then confirm.',
        roleReady: '{ready} of {total} briefed',
        begin: 'Begin the missions',
        proposalWaiting: '{name} is assembling the team',
        proposalHint: '{name} picks {count} operatives on their phone.',
        voteTitle: 'Secret ballot',
        voteProgress: '{done} of {total} ballots in',
        voteLocked: 'All ballots are in — sealed until shown.',
        revealVotes: 'Reveal the votes',
        votePassed: 'Approved',
        voteFailed: 'Rejected',
        continue: 'Continue',
        missionProgress: '{done} of {total} cards in',
        missionHint: 'The team plays in secret on their phones.',
      ...
      player: {
        ...
        joinCta: 'Join',
        joining: 'Joining…',
        notFound: 'No room answers to that code.',
        wrongMode: 'That code is for a different mode. Pick the other one from the menu.',
        full: 'This room is full.',
        inProgress: 'That operation already started without you.',
        lobby: 'You’re in, {name}. Eyes on the big screen.',
        viewRole: 'Reveal my role',
        hideRole: 'Conceal it',
        ready: 'Got it',
        waitingRoles: 'Waiting for the others to read in…',
        fellowSpies: 'Your fellow spies',
        soloSpy: 'You work alone.',
        waitingForLeader: '{name} is choosing the team.',
        voteQuestion: 'Approve this team?',
        approve: 'Approve',
        reject: 'Reject',
        voteLocked: 'Ballot sealed. Watch the big screen.',
        waitingOn: 'Still to act',
        watch: 'Watch the big screen.',
        cardPlayed: 'Your card is in.',
        notOnMission: 'You’re not on this mission. Sit tight and observe.',
        leave: 'Leave the room',
        sessionEnded: 'The host closed the room.',
        backToMenu: 'Back to menu',
      },
      hostJoin: {
        title: 'Host & Join',
        subtitle: 'No big screen. Every agent runs the op from their own phone.',
        hostCta: 'Host on this phone',
        hostBody: 'Create the room and play too — you run the op and hold a role.',
        joinCta: 'Join with a code',
        joinBody: 'Play from this phone using the room code the host reads out.',
        hostTitle: 'Host the op',
        hostSetupBody: 'Enter your codename — you take a seat and run the room.',
        createCta: 'Open the room',
        lobbyShare: 'Read this code to your agents so they can join.',
        hostTag: 'Host',
      },
    },
    scoreTrack: {
